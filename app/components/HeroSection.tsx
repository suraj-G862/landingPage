  ...
  return (
    ...
    <div className='ml-[10%] h-full w-[50%]'>
        <div className=' sm:mt-20 mt-5'>
           ...
           <p className='text-sm w-[100%] mt-5 clash-display-regular '>{hero.subheadline}</p>
           <div className='flex mt-4'>
             <button className='bg-black flex justify-center clash-display-regular items-center rounded-md sm:w-32 w-20 h-6 sm:h-10 text-white whitespace-nowrap text-xs sm:text-base ' >Get Started</button>
             <button className='ml-5 flex justify-center clash-display-regular items-center rounded-md sm:w-32 w-20 h-6 sm:h-10 whitespace-nowrap text-xs sm:text-base'><FaRegCirclePlay />Watch Video</button>
           </div>
        </div>
        <div>
